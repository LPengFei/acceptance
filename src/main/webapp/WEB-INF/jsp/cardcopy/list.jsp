...
<div class="bjui-pageHeader">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/${appid }/${modelName}?ciid=${ciid}" method="post">
        ...
        <div class="bjui-searchBar ess-searchBar">
            ...
            <%--动态生成查询条件 end --%>
            <button type="button" data-url="${ctx}/${appid }/${modelName}/edit?ciid=${ciid}" data-icon="plus"
