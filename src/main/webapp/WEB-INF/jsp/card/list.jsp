    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <c:forEach items="${page.list }" var="r" varStatus="s">
            <tr>
                ...
                <td>
                    <%--<a href="${ctx }/${appid }/${modelName }/info?cardId=${r[pkName]}" style="color:blue;"--%>
                       <%--data-toggle="navtab" data-id="${modelName }-info" data-title="${modelTitle}详情"--%>
                       <%-->详情</a>--%>
                    <%--&nbsp;--%>
                    ...
                    &nbsp;
                    <a href="${ctx}/${appid }/carditemtype/index?cid=${r.id}" data-toggle="navtab" data-id="carditemtype-list">
                        <button class="light-green-background"><span>验收大项管理</span></button>
                    </a>
                </td>
            </tr>
        </c:forEach>
