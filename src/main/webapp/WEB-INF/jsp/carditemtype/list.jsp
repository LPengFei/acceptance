...
<div class="bjui-pageHeader">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/${appid }/${modelName}" method="post">
        ...
        <div class="bjui-searchBar ess-searchBar">
            ...
            <%--动态生成查询条件 end --%>
            <button type="button" data-url="${ctx}/${appid }/${modelName}/edit?cid=${cid}" data-icon="plus"
        ...
        <c:forEach items="${page.list }" var="r" varStatus="s">
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href="${ctx}/${appid }/carditem/index?citid=${r.id}" data-toggle="navtab" data-id="carditem-list">
                        <button class="light-green-background"><span>验收小项管理</span></button>
                    </a>
                </td>
            </tr>
        </c:forEach>
