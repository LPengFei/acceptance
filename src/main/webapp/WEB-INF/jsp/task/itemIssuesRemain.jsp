...
<c:if test="${not empty resultIssues}">
    <a class="btn btn-green issue-download" href="${ctx}/${appid}/task/downloadRemainResultIssue?projectId=${projectId}" target="_blank">导出</a>
</c:if>
<div class="table" style="margin-top: 10px;">
    <table border="1" class="table">
        <tr class="title_tr">
            <th width="5%" align="center">序号</th>
            <th width="50%" align="center">缺陷（问题）描述</th>
                            ...
                            <c:otherwise>
                                ...
                                <div class="icon0">
                                    <c:forEach var="image" items="${images}" varStatus="s">
                                        <a class="fancybox fancybox-buttons" href="${ctx}/upload/${image}" rel="${resultIssue.id}">
                                        <span class="icon1" data-imgs="${resultIssue.imgs}">
                                        <c:if test="${s.count == 1}">
