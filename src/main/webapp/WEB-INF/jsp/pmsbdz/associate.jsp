        ...
        <table class="table table-bordered project-scale">
            ...
            <c:forEach items="${issues}" var="v" varStatus="s">
                <tr>
                    ...
                    <td>${v.devicename}</td>
                    <td>
                        <a href="${ctx}/${appid}/pmsdevice/associateTree?issueId=${v.id}" class="btn btn-default" data-toggle="dialog" data-width="400" data-height="800" data-id="associate-box">关联</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <table class="table table-bordered project-scale">
            ...
            <c:forEach items="${tasks}" var="v" varStatus="s">
                <tr>
                    ...
                    <td>0</td>
                    <td>
                        <a href="${ctx}/${appid}/pmsdevice/associateTree?taskId=${v.id}" class="btn btn-default" data-toggle="dialog" data-width="400" data-height="800" data-id="associate-box">关联</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
