...
<div class="bjui-pageHeader">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/${appid }/${modelName}?citid=${citid}" method="post">
        ...
        <div class="bjui-searchBar ess-searchBar">
            ...
            <%--动态生成查询条件 end --%>
            <button type="button" data-url="${ctx}/${appid }/${modelName}/edit?citid=${citid}" data-icon="plus"
                    data-toggle="navtab" data-id="${modelName }-edit" data-title="新增${modelTitle }"
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${ctx}/${appid }/${modelName }/edit/${r[pkName]}" style="color:green;" data-toggle="navtab"
                       data-id="${modelName }-edit" data-title="编辑${modelTitle }">修改</a>
                    &nbsp;
                    <a href="${ctx}/${appid }/cardstandard/index?ciid=${r.id}" data-toggle="navtab" data-id="cardstandard-list">
                        <button class="light-green-background"><span>验收标准管理</span></button>
                    </a>
                    &nbsp;
                    <a href="${ctx}/${appid }/cardcopy/index?ciid=${r.id}" data-toggle="navtab" data-id="cardcopy-list">
                        <button class="light-green-background"><span>验收抄录管理</span></button>
                    </a>
                </td>
            </tr>
        </c:forEach>
