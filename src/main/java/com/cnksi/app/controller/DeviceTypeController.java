 ...
 * 
 */
public class DeviceTypeController extends KController {
	...
	public void index() {
		...
		setAttr("page", DeviceType.me.paginate(queryParam));
	...
	public void edit() {
		...
		DeviceType record = null;
		if (idValue != null) {
			record = DeviceType.me.findById(idValue);
		}else{
	...
	public void save() {
		DeviceType record = getModel(DeviceType.class, "record");
	...
	public void delete() {
		DeviceType record = DeviceType.me.findById(getPara());
		if (record != null) {
	...
	public void export()  throws IOException {
		KWebQueryVO queryParam = super.doIndex();
		Page<DeviceType> p = DeviceType.me.paginate(queryParam);
	...
	public void json(){
		renderJson(DeviceType.me.findAllForDropDown());
	}
	public void deviceTypeName() {
		renderJson(DeviceType.me.findAllForSearch(getParaToBoolean("isFilter", false)));
	}
}
