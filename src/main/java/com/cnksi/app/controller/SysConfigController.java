 ...
 * 
 */
public class SysConfigController extends KController {
	...
	public void index() {
		...
		setAttr("page", SysConfig.me.paginate(queryParam));
	...
	public void edit() {
		...
		if (idValue != null) {
			record = SysConfig.me.findById(idValue);
		}else{
	...
	public void save() {
		SysConfig record = getModel(SysConfig.class, "record");
	...
	public void delete() {
		SysConfig record = SysConfig.me.findById(getPara());
		if (record != null) {
	...
	public void export()  throws IOException {
		KWebQueryVO queryParam = super.doIndex();
		Page<SysConfig> p = SysConfig.me.paginate(queryParam);
	...
	public void json() {
		renderJson(SysConfig.me.findChecksForDropDown());
	}
