 ...
 * 
 */
public class TaskCardController extends KController {
	...
	public void index() {
		...
		setAttr("page", TaskCard.me.paginate(queryParam));
	...
	public void edit() {
		...
		TaskCard record = null;
		if (idValue != null) {
			record = TaskCard.me.findById(idValue);
		}else{
			record = new TaskCard();
	...
	public void save() {
		TaskCard record = getModel(TaskCard.class, "record");
	...
	public void delete() {
		TaskCard record = TaskCard.me.findById(getPara());
		if (record != null) {
	...
	public void export()  throws IOException {
		KWebQueryVO queryParam = super.doIndex();
		Page<TaskCard> p = TaskCard.me.paginate(queryParam);
